...
2. Clone localmente: `git clone https://github.com/SEU_USERNAME/dio-lab-open-source.git` abrindo uma pasta onde você quer clonar esse repositorio clicando com o botão direito e selecionando o Open git bash here;
